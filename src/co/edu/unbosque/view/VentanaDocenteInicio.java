...
public class VentanaDocenteInicio extends JFrame {
	...
	public void initComp() {
		...
		numMateria = new JLabel("Cantidad de materias:");
		numMateria.setBounds(30, 410, 200, 25);
		numMateria.setFont(new Font("Agency FB", Font.BOLD, 20));
		numMateria.setForeground(Color.decode("#111d15"));
		panelMiPerfil.add(numMateria);

		tNumMateria = new JTextField();
		tNumMateria.setBounds(170, 410, 210, 25);
		tNumMateria.setFont(new Font("Agency FB", Font.BOLD, 20));
		tNumMateria.setForeground(Color.decode("#111d15"));
		tNumMateria.setBackground(Color.decode("#e0ebe0"));
		tNumMateria.setEditable(false);
		tNumMateria.setBorder(null);
		panelMiPerfil.add(tNumMateria);
